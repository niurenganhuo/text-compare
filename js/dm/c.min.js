!function (a) {
    ...
    function C(a) {
        var b = Ub(a.display), c = a.options.lineWrapping,
    ...
    function T(a) {
        ...
        if (c.length != d.lineNumChars) {
            var e = d.measure.appendChild(ug("div", [ug("div", c)], "CodeMirror-linenumber CodeMirror-gutter-elt")),
                f = e.firstChild.offsetWidth, g = e.offsetWidth - f;
    ...
    function Ma(a, b) {
        ...
        for (var d = 1; d < a.length; d++) {
            var e = a[d], f = a[d - 1];
            if (ra(f.to(), e.from()) >= 0) {
                var g = ua(f.from(), e.from()), h = ta(f.to(), e.to()),
    ...
    function cb(a, b, c, d) {
        for (var e, f = 0; f < b.ranges.length; f++) {
            var g = b.ranges[f], h = b.ranges.length == a.sel.ranges.length && a.sel.ranges[f],
                i = eb(a, g.anchor, h && h.anchor, c, d), j = eb(a, g.head, h && h.head, c, d);
    ...
    function jb(a, b, c) {
        ...
        var d = a.display, e = a.doc, f = document.createDocumentFragment(), g = rb(a.display), h = g.left,
            i = Math.max(d.sizerWidth, tb(a) - d.sizer.offsetLeft) - g.right, l = b.from(), m = b.to();
        if (l.line == m.line) k(l.line, l.ch, m.ch); else {
            var n = jf(e, l.line), o = jf(e, m.line), p = ve(n) == ve(o),
                q = k(l.line, l.ch, p ? n.text.length + 1 : null).end, r = k(m.line, p ? 0 : null, m.ch).start;
        ...
        if (b.frontier < b.first && (b.frontier = b.first), !(b.frontier >= a.display.viewTo)) {
            ...
            b.iter(b.frontier, Math.min(b.first + b.size, a.display.viewTo + 500), function (f) {
                if (b.frontier >= a.display.viewFrom) {
                    var g = f.styles, h = f.text.length > a.options.maxHighlightLength,
    ...
    function Sb(a, b, c, d, e) {
        ...
        var f = e - pf(b), g = !1, h = 2 * a.display.wrapper.clientWidth, i = Ab(a, b), k = qf(b), l = b.text.length,
            m = Wg(b), n = Xg(b), o = j(m), p = g, q = j(n), r = g;
    ...
    function Pc(a, b) {
        var d = Oc(b), e = d.x, f = d.y, g = a.display, i = g.scroller, j = i.scrollWidth > i.clientWidth,
        ...
        if (e && j || f && l) {
            ...
            20 > Mc && (null == g.wheelStartX ? (g.wheelStartX = i.scrollLeft, g.wheelStartY = i.scrollTop, g.wheelDX = e, g.wheelDY = f, setTimeout(function () {
                if (null != g.wheelStartX) {
                    var a = i.scrollLeft - g.wheelStartX, b = i.scrollTop - g.wheelStartY,
    ...
    function ud(a, b, c, d, e) {
        ...
        var o = a.curOp && null != a.curOp.scrollLeft ? a.curOp.scrollLeft : f.scroller.scrollLeft,
            p = tb(a) - (a.options.fixedGutter ? f.gutters.offsetWidth : 0), q = d - b > p;
    ...
    function ie(a, b) {
        ...
        if (!c && !d) return null;
        var e = b.from.ch, f = b.to.ch, g = 0 == ra(b.from, b.to), h = ge(c, e, g), i = he(d, f, g),
            j = 1 == b.text.length, k = gg(b.text).length + (j ? e : 0);
    ...
    function ue(a, b, c, d, e) {
        ...
        if (g) for (var h = 0; h < g.length; ++h) {
            ...
            if (i.marker.collapsed) {
                var j = i.marker.find(0), k = ra(j.from, c) || oe(i.marker) - oe(e),
    ...
    function _e(a, b, c, d) {
        ...
        var h = b.from, i = b.to, j = b.text, k = jf(a, h.line), l = jf(a, i.line), m = gg(j), n = e(j.length - 1),
            o = i.line - h.line;
    ...
    var a = navigator.userAgent, b = navigator.platform, c = /gecko\/\d/i.test(a), d = /MSIE \d/.test(a),
        e = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(a), f = d || e,
        g = f && (d ? document.documentMode || 6 : e[1]), h = /WebKit\//.test(a), i = h && /Qt\/\d+\.\d+/.test(a),
        j = /Chrome\//.test(a), k = /Opera\//.test(a), l = /Apple Computer/.test(navigator.vendor),
        m = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(a), n = /PhantomJS/.test(a),
        o = /AppleWebKit/.test(a) && /Mobile\/\w+/.test(a),
        p = o || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(a), q = o || /Mac/.test(b),
        r = /win/i.test(b), s = k && a.match(/Version\/(\d*\.\d*)/);
    ...
    Ca.prototype = mg({
        init: function (a) {
            ...
            if (a.options.moveInputWithCursor) {
                var e = Ob(a, c.sel.primary().head, "div"), f = b.wrapper.getBoundingClientRect(),
        ...
        init: function (a) {
            ...
            Ba(d), Mf(d, "paste", function (a) {
                ...
                if (b.composing = {sel: c.doc.sel, data: d, startData: d}, d) {
                    var e = c.doc.sel.primary(), f = c.getLine(e.head.line),
            ...
            var a = window.getSelection(), b = this.cm.doc.sel.primary(), d = Ha(this.cm, a.anchorNode, a.anchorOffset),
            ...
            var f;
            if (d.line == b.viewFrom || 0 == (f = oc(a, d.line))) var g = nf(b.view[0].line),
                h = b.view[0].node; else var g = nf(b.view[f].line), h = b.view[f - 1].node.nextSibling;
            var i = oc(a, e.line);
            if (i == b.view.length - 1) var j = b.viewTo - 1,
                k = b.lineDiv.lastChild; else var j = nf(b.view[i + 1].line) - 1,
    ...
    var ah, fh = function () {
        ...
        var a = "bbbbbbbbbtstwsbbbbbbbbbbbbbbssstwNN%%%NNNNNN,N,N1111111111NNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNNNLLLLLLLLLLLLLLLLLLLLLLLLLLNNNNbbbbbbsbbbbbbbbbbbbbbbbbbbbbbbbbb,N%%%%NNNNLNNNNN%%11NLNNN1LNNNNNLLLLLLLLLLLLLLLLLLLLLLLNLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLN",
            ...
            d = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, e = /[stwN]/, f = /[LRr]/, g = /[Lb1n]/, h = /[1n]/,
            i = "L";
        return function (a) {
